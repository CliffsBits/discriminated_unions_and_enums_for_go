...
const (
	...
	OMAKEBOX         // construct a box value from type tag and data pointers
	OBTAB            // type tag of a box value
	OBDATA           // data pointer of a box value
	...
	// box type operations
	OCONVBOX     // Type(X) (type conversion, to box)
