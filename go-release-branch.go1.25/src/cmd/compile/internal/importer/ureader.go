...
func (r *reader) doTyp() (res types2.Type) {
	...
	case pkgbits.TypeBox:
		// TODO: Implement box type reading when Box type is added to types2
		// Temporarily return empty interface{} to avoid crashes during bootstrap
		return types2.NewInterfaceType(nil, nil)
	}
}
