...
func cmpT1(p, q *T1) {
	if *p != *q {
		panic("comparison test wrong " + "2a80eec5")
	}
}
...
func cmpT2(p, q *T2) {
	if *p != *q {
		panic("comparison test wrong " + "91c8cd67")
	}
}
...
func cmpA2(p, q *A2) {
	if *p != *q {
		panic("comparison test wrong " + "0ca14b8d")
	}
}
...
func cmpA4(p, q *A4) {
	if *p != *q {
		panic("comparison test wrong " + "cc6fded5")
	}
}
...
func cmpA8(p, q *A8) {
	if *p != *q {
		panic("comparison test wrong " + "e2b01f5b")
	}
}
