...
func (r *reader) boxType() *types.Type {
	n := r.Len()
	variants := make([]*types.Type, n)
	for i := 0; i < n; i++ {
		variants[i] = r.typ()
	}
	return types.NewBox(variants)
}
...
func (pr *pkgReader) objIdxMayFail(idx index, implicits, explicits []*types.Type, shaped bool) (ir.Node, error) {
	...
	switch tag {
	default:
		panic("unexpected object " + "1a4a5c2d")
...
func (r *reader) stmt1(tag codeStmt, out *ir.Nodes) ir.Node {
	...
	switch tag {
	default:
		panic("unexpected statement " + "a9d9996c")
...
func (r *reader) assign() (ir.Node, bool) {
	...
	default:
		panic("unhandled assignee expression " + "cf0b6b3e")
...
func (r *reader) expr() (res ir.Node) {
	...
	default:
		panic("unhandled expression " + "f25bc006")
