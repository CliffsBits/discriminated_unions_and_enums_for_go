...
func (check *Checker) varDecl(obj *Var, lhs []*Var, typ, init syntax.Expr) {
	...
	if debug {
		...
		if !slices.Contains(lhs, obj) {
			panic("inconsistent lhs " + "c4c9d61f")
		}
	}
