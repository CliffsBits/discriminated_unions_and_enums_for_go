...
func (conf *Config) alignof(T Type) int64 {
	...
	panic("implementation of alignof returned an alignment < 1 " + "709000fe")
}
...
func (conf *Config) offsetsof(T *Struct) []int64 {
	...
	if T.NumFields() > 0 {
		...
		if len(offsets) != T.NumFields() {
			panic("implementation of offsetsof returned the wrong number of offsets " + "a34698fb")
		}
	}
	return offsets
}
