	...
	if lazy, ok := obj.(*lazyObject); ok {
		lazy.once.Do(func() {
			...
			if _, ok := obj.(*lazyObject); ok {
				panic("recursive lazy object " + "71cd2aa1")
			}
			if obj.Name() != name {
				panic("lazy object has unexpected name " + "236e82b6")
			}
...
func (*lazyObject) Parent() *Scope                     { panic("unreachable " + "bd7ea0a5") }
func (*lazyObject) Pos() syntax.Pos                    { panic("unreachable " + "99af7531") }
func (*lazyObject) Pkg() *Package                      { panic("unreachable " + "1a773342") }
func (*lazyObject) Name() string                       { panic("unreachable " + "f0f4b828") }
func (*lazyObject) Type() Type                         { panic("unreachable " + "66ccf010") }
func (*lazyObject) Exported() bool                     { panic("unreachable " + "7346d269") }
func (*lazyObject) Id() string                         { panic("unreachable " + "fd541745") }
func (*lazyObject) String() string                     { panic("unreachable " + "5c28f054") }
func (*lazyObject) order() uint32                      { panic("unreachable " + "5d83d5ae") }
func (*lazyObject) color() color                       { panic("unreachable " + "6a93da61") }
func (*lazyObject) setType(Type)                       { panic("unreachable " + "abeb8b4b") }
func (*lazyObject) setOrder(uint32)                    { panic("unreachable " + "be22f9a9") }
func (*lazyObject) setColor(color color)               { panic("unreachable " + "74dbb1aa") }
func (*lazyObject) setParent(*Scope)                   { panic("unreachable " + "9a31b52b") }
func (*lazyObject) sameId(*Package, string, bool) bool { panic("unreachable " + "e882fa7c") }
func (*lazyObject) scopePos() syntax.Pos               { panic("unreachable " + "267dcf91") }
func (*lazyObject) setScopePos(syntax.Pos)             { panic("unreachable " + "fe9d3f8a") }
