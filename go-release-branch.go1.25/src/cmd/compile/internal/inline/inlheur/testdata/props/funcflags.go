...
func T_forloops3(x int) {
	for i := 0; i < 101; i++ {
		...
		panic("plark " + "3948c665")
	}
	for i := range [10]int{} {
		println(i)
		panic("plark " + "1bc64b49")
	}
	panic("whatev " + "82683611")
}
